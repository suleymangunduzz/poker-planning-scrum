export const ADD_POINT_TO_STORY_REQUEST = 'ADD_POINT_TO_STORY_REQUEST';
export const ADD_POINT_TO_STORY_SUCCESS = 'ADD_POINT_TO_STORY_SUCCESS';
export const ADD_POINT_TO_STORY_FAILURE = 'ADD_POINT_TO_STORY_REQUEST';
